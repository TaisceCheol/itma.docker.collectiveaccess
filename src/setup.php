...
#
// __CA_DB_HOST__ = getenv('MYSQL_PORT_3306_TCP_ADDR');
#
if (!defined("__CA_DB_HOST__")) {
	define("__CA_DB_HOST__", getenv('MYSQL_PORT_3306_TCP_ADDR'));
}

// __CA_DB_USER__ = "piaras.hoban@itma.ie";
#
if (!defined("__CA_DB_USER__")) {
	define("__CA_DB_USER__", 'piaras.hoban@itma.ie');
}

// __CA_DB_PASSWORD__ = "itmaMA123$$";
#
if (!defined("__CA_DB_PASSWORD__")) {
	define("__CA_DB_PASSWORD__", 'itMA123$$');
}

// __CA_DB_DATABASE__ = "itma_ca";
#
if (!defined("__CA_DB_DATABASE__")) {
	define("__CA_DB_DATABASE__", 'itma_ca');
}
